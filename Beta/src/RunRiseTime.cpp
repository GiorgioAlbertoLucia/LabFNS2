...
void doubleCanvas(const char * outputPath)
{
    ...
    TF1 * fit2 = new TF1("landau", "landau", 200, 500);
    ...
    TH1F * frame2 = pad2->DrawFrame(0, 0, 1200, 250, "Rise Time - Channel 2; Rise Time (ps); Counts");
    ...
    latex2->DrawLatexNDC(0.45, 0.7, Form("Rise Time = %.f #pm %.f ps", fit2->GetParameter(1) + 0.5772 * fit2->GetParameter(2), fit2->GetParameter(2)));
    ...
    leg2->AddEntry(fit2, "Landau fit", "l");
    ...
    TF1 * fit3 = new TF1("landau", "landau", 350, 700);
    ...
    TH1F * frame3 = pad3->DrawFrame(-300, 0, 2200, 2000, "Rise Time - Channel 3; Rise Time (ps); Counts");
    ...
    latex3->DrawLatexNDC(0.45, 0.7, Form("Rise Time = %.f #pm %.f ps", fit3->GetParameter(1) + 0.5772 * fit3->GetParameter(2), fit3->GetParameter(2)));
    ...
    leg3->AddEntry(fit3, "Landau fit", "l");
 ...
 * 
 */
void RunRiseTime(const bool drawOnly = false) 
{
