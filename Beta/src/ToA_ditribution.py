...
if __name__=='__main__':
    ...
    canvasSysUp.cd(1).DrawFrame(240, 30,len(theshold2SystUp)*len(theshold3SystUp), 70, "Resolution vs cut;Cut;Resolution")
    ...
    hResvsThUp.SetAxisRange(48.,55.,"z")
    ...
    hResFitvsThUp.SetAxisRange(37., 41.,"z")
    hResFitvsThUp.Draw("colz")
    canvasSysUp.cd(4).DrawFrame(30, 0, 70, 150, "Resolution distribution;Resolution;Counts")
