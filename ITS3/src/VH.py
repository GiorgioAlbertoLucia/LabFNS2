...
if __name__=='__main__':
    ...
    canvas = TCanvas("canvas","canvas",1500,650)
    canvas.Divide(2,1)
    canvas.cd(1)
    ...
    text2 =TLatex(0.15, 0.8,"APTS_AO10P_B6, Pixel 5")
    text2.SetNDC()
    ...
    canvasf = TCanvas("canvasf","canvasf",750,650)
    canvasf.cd()
    hFrame = canvasf.DrawFrame(0,0,1.3,5,"Falltime vs VH; VH (V); Falltime (ns)")
    gFalltime.Draw("p,same")
    text3 =TLatex(0.4, 0.7,"APTS_AO10P_B6, Pixel 5")
    text3.SetNDC()
    text3.SetTextSize(gStyle.GetTextSize())
    text3.SetTextFont(42)
    text3.Draw()
    canvasf.SaveAs('ITS3/data/output/Falltime_VH.pdf')